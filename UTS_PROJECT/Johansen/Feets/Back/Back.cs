...
namespace UTS_PROJECT.Johansen.Feets
{
    class Back
    {
        ...
        public feets.backs.left left;
        public feets.backs.right right;
        public Vector3 rotation = new Vector3(0f, 0f, 0f);

        //Steve.feets.front.right right;
        public Back()
        {
            left = new feets.backs.left();
            right = new feets.backs.right();
        }
        ...
        public void setPosition(Vector3 pos)
        {
            ...
            left.setPosition(new Vector3(pos.X - 0.2f / 2f, pos.Y, pos.Z));
            right.setPosition(new Vector3(pos.X + 0.2f / 2f, pos.Y, pos.Z));
