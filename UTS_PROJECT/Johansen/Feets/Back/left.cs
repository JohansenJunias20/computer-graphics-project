...
namespace UTS_PROJECT.Johansen.feets.backs
{
    class left
    {
        ...
        float palmDeg = 0f;
        public void RotatePalm(float degX)
        {
            palmDeg += degX;
            //Vector3 initialPos = new Vector3( forearm._position.X,forearm._position.Y,forearm._position.Z);
            ...
            palm._transform *= Matrix4.CreateTranslation(-palm._position.X, -palm._position.Y - palm.sizeBox.Y / 2f + palm.sizeBox.Z / 2f, -palm._position.Z);
        ...
        public void setPosition(Vector3 pos)
        {
            ...
            forearm.setPosition(new Vector3(arm._position.X, arm._position.Y - arm.sizeBox.Y / 2f - forearm.sizeBox.Y / 2f + arm.sizeBox.Z / 2f + forearm.sizeBox.Z /2f, pos.Z)) ;
