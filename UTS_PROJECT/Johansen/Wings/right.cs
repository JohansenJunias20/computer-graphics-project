...
namespace UTS_PROJECT.Johansen
{
    class right
    {
        ...
        public Vector3 outerRotation = new Vector3(0f, 0f, 10f);
        ...
        public void Animate()
        {
            ...
            furInner._transform *= Matrix4.CreateRotationZ(MathHelper.DegreesToRadians(180f));
            //furInner._transform *= Matrix4.CreateRotationX(MathHelper.DegreesToRadians(180f));
